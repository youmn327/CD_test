...
1. GitHub 저장소 페이지로 이동: https://github.com/youmn327/CD_test
2. **Settings** 탭 클릭
3. 왼쪽 메뉴에서 **Pages** 클릭
4. **Source** 항목에서:
   - Branch: `main`
...
```
https://youmn327.github.io/CD_test/
```

- 대시보드: `https://youmn327.github.io/CD_test/`
- JJW 제출: `https://youmn327.github.io/CD_test/jjw/`
- NYM 제출: `https://youmn327.github.io/CD_test/nym/`
